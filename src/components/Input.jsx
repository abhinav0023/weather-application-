  ...
  return (
    <div className='flex flex-row justify-center my-6'>
        ...
        <div className='flex flex-row w-1/4 items-center justify-center'>
          <button className='text-2xl font-medium transition ease-out hover:scale-150'>°C</button>
          <p className='text-2xl font-medium mx-1'></p>
          <button className='text-2xl font-medium transition ease-out hover:scale-150'>°F</button>
        </div>
    </div>
  )
}
